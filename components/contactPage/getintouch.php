                ...
                <div class="form-wrap">
                    ...
                    <form class="w-full"> 
                        <div class="w-full group">
                            <input type="text" id="name-input" class="block w-full p-2.5" placeholder="Name">                           
                        </div>
                        <div class="w-full group">
                            <input type="Email" id="email-input" class="block w-full p-2.5" placeholder="Email">                           
                        </div>
                        <div class="w-full group">
                            <input type="text" id="company-input" class="block w-full p-2.5" placeholder="Company Name">                           
                        </div>
                        <div class="w-full group">
                            <input type="text" id="subject-input" class="block w-full p-2.5" placeholder="Subject">                           
                        </div>
                        <div class="w-full group">
                            <textarea id="message" rows="4" class="block p-2.5 w-full" placeholder="Message"></textarea>                           
                        </div>
                        <div class="flex justify-center">
                            <a type="button" class="btn btn-secondary cursor-pointer">Submit</a>
                        </div>
                    </form>
                </div>
            </div>
