...
document.addEventListener("DOMContentLoaded", () => {
        ...
        // 1. Show first banner on page load
        firstBanner.classList.remove('hidden');
        secondBanner.classList.add('hidden');
        
        // 4. Add class to header when showing first banner
        header.classList.add('banner-active');
        
        // Function to handle banner transition on tab button click
        function handleTabClick() {
            // 2. Hide first banner and show second banner on tab click
            firstBanner.classList.add('hidden');
            secondBanner.classList.remove('hidden');
            ...
            // Initialize the tab system for the second banner
            initTabSystem();
        }
        
        // Add click event listeners to all tab buttons in first banner
        const firstBannerButtons = firstBanner.querySelectorAll('.tab-button');
        firstBannerButtons.forEach(button => {
